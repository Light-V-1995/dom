...
})({"1qnnp":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "06859c556d59587e576a7dc02b8368af"; // @flow
...
window.jQuery = (selectorOrArray)=>{
    ...
    return {
        ...
        siblings () {
            ...
            // }
            this.each((node)=>{
                array = array.concat(Array.from(node.parentNode.children).filter((n)=>n !== node
                ));
            });
            return jQuery(array);
        },
        index () {
            this.each((node)=>{
                ...
                for(let i = 0; i < list.length; i++)if (node === list[i]) console.log(i);
            });
            return this;
        },
        next () {
...
},{}]},["1qnnp","4DLCo"], "4DLCo", "parcelRequire427e")
